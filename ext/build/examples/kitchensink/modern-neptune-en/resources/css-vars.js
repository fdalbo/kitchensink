...
var __rt_context = __rt.context,
    ...
    __rt_extenders = __rt.extenders,
    __rt__scopeStack = __rt._scopeStack;
__rt_setDynamic("$theme_name", __rt_getGlobalDefault("$theme_name") || new __Text("theme-neptune", "'"), 0);
__rt_setDynamic("$content-panel-grid-line", __rt_getGlobalDefault("$content_panel_grid_line") || (__rt_test(__rt.operate("==",__rt_get("$theme_name"), new __Text("theme-material", "'"))) ? (__rt_test(__rt_get("$dark_mode")) ? __ColorRGBA.fromHex("#3a3a3a") : __ColorRGBA.fromHex("#f5f5f5")) : (__rt_test(__rt.operate("==",__rt_get("$theme_name"), new __Text("theme-ios", "'"))) ? __ColorRGBA.fromHex("#EFEFF4") : __ColorRGBA.fromHex("#f5f5f5"))), 1);
__rt_setDynamic("$content-panel-grid-background", __rt_getGlobalDefault("$content_panel_grid_background") || (__rt_test(__rt.operate("==",__rt_get("$theme_name"), new __Text("theme-ios", "'"))) ? __rt_get("$content_panel_grid_line") : __rt_box(__rt_registered.darken.apply(__rt.registered, __rt_applySpreadArgs([
